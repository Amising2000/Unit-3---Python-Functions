...
def calculate_engagement(likes, shares, comments):
    """Calculate the total media engagment.
    This function takes the number of likes, shares, and comments on a post and return the total engajment count.
    ...
    Return:
        int: the total engagment, calculated as the sum of likes, shares, and comments
        example: >>>calculate_engagment(120,45,30)
        195
    """
    total = likes + shares + comments
    print(f"Total engagment: {total}")
    return
